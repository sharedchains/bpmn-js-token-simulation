...
function StartEventHandler(animation, eventBus, elementRegistry, processInstances, logEvents) {
...
StartEventHandler.prototype.consume = function(context) {
  ...
  self._logEvents.stringify(context, 2, null, 2);
...
StartEventHandler.$inject = [ 'animation', 'eventBus', 'elementRegistry', 'processInstances', 'logEvents' ];
