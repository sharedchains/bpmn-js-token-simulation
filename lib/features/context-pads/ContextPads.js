...
function ContextPads(eventBus, elementRegistry, overlays, injector, canvas, processInstances) {
  ...
  this.registerHandler('bpmn:BusinessRuleTask', TaskHandler);
  this.registerHandler('bpmn:CallActivity', TaskHandler);
  this.registerHandler('bpmn:ManualTask', TaskHandler);
  this.registerHandler('bpmn:ScriptTask', TaskHandler);
  this.registerHandler('bpmn:SendTask', TaskHandler);
  this.registerHandler('bpmn:ServiceTask', TaskHandler);
  this.registerHandler('bpmn:Task', TaskHandler);
  this.registerHandler('bpmn:UserTask', TaskHandler);
