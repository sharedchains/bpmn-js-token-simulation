...
ToggleAutomatic.prototype._init = function() {
  this.container = domify(`
    <div class="toggle-automatic hidden">
      Automatic&nbsp;<span class="toggle">${ MagicIcon() }&nbsp;${ ToggleOnIcon() }</span>
    </div>
  `);
...
ToggleAutomatic.prototype.toggleAutomatic = function() {
  if (!this.disabled) {
    if (this.automaticMode) {
      this.container.innerHTML = `Automatic&nbsp;<span class="toggle">${ MagicIcon() }&nbsp;${ ToggleOffIcon() }</span>`;
      ...
      this.container.innerHTML = `Automatic&nbsp;<span class="toggle">${ MagicIcon() }&nbsp;${ ToggleOnIcon() }</span>`;
